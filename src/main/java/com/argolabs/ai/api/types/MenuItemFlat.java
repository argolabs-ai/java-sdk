...
@JsonDeserialize(builder = MenuItemFlat.Builder.class)
public final class MenuItemFlat {
    ...
    private final Optional<List<String>> modifierExternalIds;

    private final int id;

    private final Map<String, Object> additionalProperties;

    private MenuItemFlat(
            String externalId,
            ...
            Optional<List<String>> modifierExternalIds,
            int id,
        ...
        this.modifierExternalIds = modifierExternalIds;
        this.id = id;
    ...
    @JsonProperty("modifier_external_ids")
    public Optional<List<String>> getModifierExternalIds() {
        return modifierExternalIds;
    }
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof MenuItemFlat && equalTo((MenuItemFlat) other);
    }
    ...
    private boolean equalTo(MenuItemFlat other) {
        return externalId.equals(other.externalId)
                ...
                && modifierExternalIds.equals(other.modifierExternalIds)
                && id == other.id;
    }
    ...
    public interface ExternalIdStage {
        ...
        Builder from(MenuItemFlat other);
    }
    ...
    public interface TaxStage {
        SellSeparatelyStage tax(int tax);
    }

    public interface SellSeparatelyStage {
        IdStage sellSeparately(boolean sellSeparately);
    }
    ...
    public interface _FinalStage {
        ...
        _FinalStage modifierExternalIds(Optional<List<String>> modifierExternalIds);

        _FinalStage modifierExternalIds(List<String> modifierExternalIds);
    }

    @JsonIgnoreProperties(ignoreUnknown = true)
    public static final class Builder
            implements ExternalIdStage, NameStage, PriceStage, TaxStage, SellSeparatelyStage, IdStage, _FinalStage {
        ...
        private Optional<List<String>> modifierExternalIds = Optional.empty();
        ...
        @java.lang.Override
        public Builder from(MenuItemFlat other) {
            ...
            modifierExternalIds(other.getModifierExternalIds());
            id(other.getId());
            return this;
        }
        ...
        @java.lang.Override
        @JsonSetter("tax")
        public SellSeparatelyStage tax(int tax) {
            this.tax = tax;
            return this;
        }
        ...
        public IdStage sellSeparately(boolean sellSeparately) {
            this.sellSeparately = sellSeparately;
            return this;
        }
        ...
        @java.lang.Override
        public _FinalStage modifierExternalIds(List<String> modifierExternalIds) {
            this.modifierExternalIds = Optional.ofNullable(modifierExternalIds);
            return this;
        }

        @java.lang.Override
        @JsonSetter(value = "modifier_external_ids", nulls = Nulls.SKIP)
        public _FinalStage modifierExternalIds(Optional<List<String>> modifierExternalIds) {
            this.modifierExternalIds = modifierExternalIds;
            return this;
        }
        ...
        @java.lang.Override
        public MenuItemFlat build() {
            return new MenuItemFlat(
                    externalId,
                    name,
                    description,
                    price,
