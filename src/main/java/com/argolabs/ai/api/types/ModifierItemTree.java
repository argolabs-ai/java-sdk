...
@JsonDeserialize(builder = ModifierItemTree.Builder.class)
public final class ModifierItemTree {
    ...
    public boolean equals(Object other) {
        ...
        return other instanceof ModifierItemTree && equalTo((ModifierItemTree) other);
    }
    ...
    private boolean equalTo(ModifierItemTree other) {
        return id == other.id
    ...
    public interface IdStage {
        ...
        Builder from(ModifierItemTree other);
    }
    ...
    public interface TaxChangeStage {
        InStockStage taxChange(int taxChange);
    }

    public interface InStockStage {
        MinQuantityStage inStock(boolean inStock);
    }
    ...
    public interface DefaultQuantityStage {
        _FinalStage defaultQuantity(int defaultQuantity);
    }

    public interface _FinalStage {
        ModifierItemTree build();
    ...
    public static final class Builder
        ...
        @java.lang.Override
        public Builder from(ModifierItemTree other) {
            id(other.getId());
        ...
        public InStockStage taxChange(int taxChange) {
            this.taxChange = taxChange;
            return this;
        }
        ...
        @java.lang.Override
        @JsonSetter("in_stock")
        public MinQuantityStage inStock(boolean inStock) {
            this.inStock = inStock;
            return this;
        }
        ...
        public _FinalStage defaultQuantity(int defaultQuantity) {
            this.defaultQuantity = defaultQuantity;
            return this;
        }
        ...
        @java.lang.Override
        public ModifierItemTree build() {
            return new ModifierItemTree(
                    id,
                    externalId,
                    menuItemExternalId,
                    name,
